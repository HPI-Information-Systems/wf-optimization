...
WindowExecutorLocalState::WindowExecutorLocalState(ExecutionContext &context, const WindowExecutorGlobalState &gstate) : has_filter{false}, sel{nullptr}, match_count{0} {
}
